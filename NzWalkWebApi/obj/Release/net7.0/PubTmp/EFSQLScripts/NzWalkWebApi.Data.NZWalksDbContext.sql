...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230524062523_Initial Migration')
BEGIN
...
BEGIN
    ...
    VALUES (N'20230524062523_Initial Migration', N'7.0.5');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230525072319_Seeding data')
BEGIN
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230525072319_Seeding data', N'7.0.5');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230529125150_Adding images table')
BEGIN
    CREATE TABLE [Images] (
        [Id] uniqueidentifier NOT NULL,
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230529125150_Adding images table', N'7.0.5');
END;
GO
